                ...
                <div class="col-lg-8 py-2">
                    <div class="card p-3">
                        <form action="" class="form_buy_now" id="billingForm">
                            ...
                            <div class="fields fields--2">
                                ...
                                <label class="field">
                                    ...
                                    <input class="field__input" type="text" name="lastname" id="lastname"
                                        placeholder="Doe" />
                                </label>
                            </div>
                            <div class="fields fields--2">
                                ...
                                <label class="field">
                                    ...
                                    <input class="field__input" type="text" name="phone" id="phone"
                            ...
                            <div class="fields fields--2">
                                <label class="field">
                                    ...
                                    <input class="field__input" type="text" name="pincode" id="Pincode"
                        ...
                        <div class="w-100 view_detail">
                            ...
                            <button id="rzp-button1" class="btn btn-outline-dark btn-lg" style="display: none;"><i
                                    class="fas fa-money-bill"></i> Pay With Razorpay</button>
                            <a id="cod-pay" href="{{ route('buy_now_cod', ['order_id' => $order->id]) }}"
                                class="btn btn-outline-dark btn-lg" style="display: none;"><i
                                    class="fas fa-money-bill"></i> COD</a>
                        </div>
                    </div>
                    <!--  -->
                    <!--  -->
