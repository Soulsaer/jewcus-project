                            ...
                            <div class="content-container mb-50">
                                <div class="content hide-scroll-bar">
                                    <div class="row m-0 ">
                                        ...
                                        <div class="col-lg-6 my-2" style="height: 400px;">
                                            <div class="product-image-slider bg-light">
                                                ...
                                                <div style="position:relative; background-color: white;height: 680px;">
                                                    <img src="{{ asset('assets/earring.png') }}"
                                                        style="position: absolute;top: 0;left:0; z-index: 99;"
                                                        alt="">
                                                    <img id="skinToneImage" src="{{ asset('assets/light.jpeg') }}"
                                                        alt="Skin Tone Image">
                                                    <input type="range" min="0" max="100" value="0"
                                                        id="skinToneRange"
                                                        style=" transform: rotate(90deg); position: absolute;top: 50%;right: -116px;">
                                                </div>
                                                <!-- <div style="position:relative; width: 500px; background-color: white;height: 680px;">
                                        ...
                                        <div class="col-lg-6 my-2" style="height: 400px;">
                                            <div class="product-image-slider bg-light">
                                                <figure class="border-radius-10 ">
                                                    <img src="{{ asset('storage/' . $product->test_three) }}"
                                                        class="h-100" alt="product image">
                                                </figure>
                                            </div>
                                        </div>
                                ...
                                <div class="content-sidebar">
                                    <div class="detail-info content-navigation">
                                        <h2 class="title-detail fs-4  mt-2 " style="line-height: 26px;">
                                            {{ $product->name }}</h2>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand"
                                                        style="color: black !important;">${{ $product->special_price }}
                                                    </span></ins>
                                                <ins><span
                                                ...
                                                @endphp
                                                <span class="save-price  font-md color3 ml-15">{{ intval(100 - $per) }}%
                                                    Off</span>
                                            </div>
                                        </div>
                                                ...
                                                <div class="pt-3 d-flex align-items-center justify-content-start">
                                                    @foreach ($product->gemstone_variants as $variant)
                                                        <div class="px-2 input_radio">
                                                            ...
                                                            <label for="sad">
                                                                <a href="{{ $variant->link }}" data-toggle="tooltip"
                                                                    data-placement="top"
                                                                    title="{{ $variant->variant->name }}"><img
                                                                        src="{{ asset('storage/' . $variant->variant->image) }}"
                                                                        alt="{{ $variant->variant->alt }}" /></a>
                                                            </label>
                                                            <!-- <a href="{{ $variant->link }}">
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li class="mb-5">Tags: <a href="#" rel="tag">Ring</a>,
                                                <a href="#" rel="tag">Neckless</a>, <a href="#"
                                                    rel="tag">Jwelery</a>
                                            </li>
                                                ...
                                                <div class="card-1  wow fadeIn animated hover-up animated animated ">
                                                    <div class="product-cart-wrap">
                                                        <div class="product-img-action-wrap p-0 m-0">
                                                            <div class="product-img product-img-zoom border-0">
                                                                <a href="shop-product-right.html"
                                                                    class="product-name-class" tabindex="0">
                                                                    <img class="default-img"
                                                                        src="{{ asset('storage/' . $product->product_image) }}"
                                                                        alt="">
                                                                    <img class="hover-img"
                                                                        src="{{ asset('storage/' . $product->second_image) }}"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="product-content-wrap p-0">
                                                            <span><a href="shop-product-right.html"
                                                    ...
                                                    <div class="product-cart-wrap">
                                                        <div class="product-img-action-wrap p-0 m-0">
                                                            <div class="product-img product-img-zoom border-0">
                                                                <a href="{{ $variant->link }}" class="product-name-class"
                                                                    tabindex="0">
                                                                    <img class="default-img"
                                                                        src="{{ asset('storage/' . $variant->product->product_image) }}"
                                                                        alt="">
                                                                    <img class="hover-img"
                                                                        src="{{ asset('storage/' . $variant->product->second_image) }}"
                                                                        alt="">
                                                                </a>
                                                            </div>
                                                            <div class="product-action-1">
                                                        ...
                                                        <div class="product-content-wrap p-0">
                                                            ...
                                                            <div class="product-price">
                                                                ...
                                                                <span
                                                                    class="old-price">${{ $variant->product->price }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script>
        ...
        rangeInput.addEventListener('input', function() {
            ...
            for (let i = 0; i < combinedImageData.data.length; i += 4) {
                combinedImageData.data[i] = Math.round(lightImageData.data[i] * (1 - percentage) + darkImageData
                    .data[i] * percentage);
                combinedImageData.data[i + 1] = Math.round(lightImageData.data[i + 1] * (1 - percentage) +
                    darkImageData.data[i + 1] * percentage);
                combinedImageData.data[i + 2] = Math.round(lightImageData.data[i + 2] * (1 - percentage) +
                    darkImageData.data[i + 2] * percentage);
